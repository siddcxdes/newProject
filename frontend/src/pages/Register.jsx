        ...
        <div className="min-h-screen bg-black flex items-center justify-center p-4">
            <div className="w-full max-w-sm">
                ...
                <form onSubmit={handleSubmit} className="glass-card p-6 space-y-4">
                    ...
                    <div>
                        <label className="block text-xs text-zinc-500 uppercase tracking-wide mb-2">Name</label>
                        <input
                            type="text"
                            value={formData.name}
                    ...
                    <div>
                        <label className="block text-xs text-zinc-500 uppercase tracking-wide mb-2">Confirm Password</label>
                        <input
                            type="password"
